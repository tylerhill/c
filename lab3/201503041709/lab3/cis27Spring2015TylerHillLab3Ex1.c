...
void menu() {
	...
	do {
		...
		case 2:
			...
			break;
		case 3:
			subtractFraction(lOp,rOp);
			break;
		case 4:
			multiplyFraction(lOp,rOp);
			break;
		case 5:
			divideFraction(lOp,rOp);
			break;
		case 6:
			printf("");
			printf("\nLeft Operand:");
...
frPtr addFraction(frPtr fr1, frPtr fr2) {
	frPtr frResult;
...
frPtr subtractFraction(frPtr fr1, frPtr fr2) {
	frPtr frResult;
	frResult = (frPtr) malloc(sizeof(frac));
	frResult->num = ((fr1->num) * (fr2->denom) - (fr1->denom) * (fr2->num));
	frResult->denom = ((fr1->denom) * (fr2->denom));
...
frPtr multiplyFraction(frPtr fr1, frPtr fr2) {
	frPtr frResult;
	frResult = (frPtr) malloc(sizeof(frac));
